...
![Description](https://obr-npc-stats.vercel.app/SaveNPCStats.png)
...
## Revision
2.10 Added Advantage / Disadvantage.

2.9  Added Critical Hit / Fail with dice doubling.

2.8  Added Initiative tracking module.

2.7  Added Game Log.

2.6  Added Charge / Recharge to abilities.

2.5  Added Charge / Recharge to attacks.

2.1  Added automatic combat resolution.
